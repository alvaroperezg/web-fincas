    ...
    <section id="contacto" className="py-20 bg-card/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">Estamos aquí para ayudarte. Consulta gratuita sin compromiso.</p>
        </div>
          ...
          <div className="space-y-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p>Avenida Meco 1</p>
                <p className="text-muted-foreground">Azuqueca de Henares, Guadalajara<br/>Castilla-La Mancha, España</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">+34 949 26 24 95<br/>Lunes a Viernes: 9:00 - 18:00</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">fincasdobleg@gmail.com<br/>Respuesta &lt; 24 horas</p>
              </div>
            </div>
          </div>
          <Card>
